...
bDWithoutMono = pd.read_excel(r'БД_без_моно_full.xlsx')
bDMono = pd.read_excel(r'БД_с_моно_full.xlsx')
...
d1 = pd.read_excel(r'Показатель_D 1.xlsx')
f1 = pd.read_excel(r'Показатель_F 1.xlsx')
